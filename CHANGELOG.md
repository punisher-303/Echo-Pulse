...
- **Discord RPC**: Now you can integrate with your discord and update the status with others what you listening.
- **APP UI**: App UI is entirely new and easy for users.
...
- **App Backend**: App backend performance make better and without delay in music play.
- **Provider**: change built-in provider to external. and new update will through server side.
- **Music Fetching**: Music fetching speed improving.now it will fetch without any delay.
